...
/// <summary>
/// Provides System.Text.Json serialization extensions for message strings.
/// </summary>
public static class SagaMessageTemplatesJsonExtensionsJsonExtensions
{
    ...
    /// <summary>
    /// Serializes a message string to a JSON string.
    /// </summary>
    /// <param name="message">The message to serialize.</param>
    /// <param name="indented">Whether to format the JSON with indentation for readability.</param>
    /// <returns>A JSON string representation of the message.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="message"/> is null.</exception>
    public static string ToJson(this string message, bool indented = false)
    {
