...
namespace SagaOrchestrator.Tests
{
    public class ConfigurationExceptionJsonExtensionsTests
    {
        ...
        {
            // Arrange
            var originalException = new ConfigurationException("Deserialization test");
            var json = originalException.ToJson();

            // Act
            var result = ConfigurationExceptionJsonExtensions.FromJson(json);
        ...
        public void FromJson_InvalidJson_ReturnsNull()
        {
            ...
            // Act
            var result = ConfigurationExceptionJsonExtensions.FromJson(invalidJson);
        ...
        {
            // Act & Assert
            Assert.Throws<ArgumentException>(() => ConfigurationExceptionJsonExtensions.FromJson(null!));
            Assert.Throws<ArgumentException>(() => ConfigurationExceptionJsonExtensions.FromJson(string.Empty));
        }
        ...
        {
            // Arrange
            var originalException = new ConfigurationException("TryParse test");
            var json = originalException.ToJson();

            // Act
            var success = ConfigurationExceptionJsonExtensions.TryFromJson(json, out var result);
        ...
        public void TryFromJson_InvalidJson_ReturnsFalseAndNull()
        {
            ...
            // Act
            var success = ConfigurationExceptionJsonExtensions.TryFromJson(invalidJson, out var result);
