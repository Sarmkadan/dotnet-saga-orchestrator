...
/// <summary>
/// Tests for SagaMessageTemplatesJsonExtensionsJsonExtensions class.
/// </summary>
public class SagaMessageTemplatesJsonExtensionsJsonExtensionsTests
{
    #region ToJson Tests
    ...
    public void ToJson_ShouldSerializeSimpleString()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.ToJson(message);
    ...
    public void ToJson_WithIndentedTrue_ShouldFormatWithIndentation()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.ToJson(message, indented: true);

        // Assert
        result.Should().Be("\"Hello World\""); // Even with indentation, single values don't add newlines
    }
    ...
    public void ToJson_ShouldThrowArgumentNullException_WhenMessageIsNull()
    {
        ...
        // Act
        Action act = () => SagaMessageTemplatesJsonExtensionsJsonExtensions.ToJson(message!);
    ...
    public void FromJson_ShouldDeserializeValidJsonString()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.FromJson(json);
    ...
    public void FromJson_ShouldReturnNull_WhenJsonIsInvalid()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.FromJson(invalidJson);
    ...
    public void FromJson_ShouldReturnNull_WhenJsonIsMalformed()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.FromJson(malformedJson);
    ...
    public void FromJson_ShouldThrowArgumentNullException_WhenJsonIsNull()
    {
        ...
        // Act
        Action act = () => SagaMessageTemplatesJsonExtensionsJsonExtensions.FromJson(json!);
    ...
    public void TryFromJson_ShouldReturnTrueAndValue_WhenJsonIsValid()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.TryFromJson(json, out value);
    ...
    public void TryFromJson_ShouldReturnFalseAndNull_WhenJsonIsInvalid()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.TryFromJson(invalidJson, out value);
    ...
    public void TryFromJson_ShouldReturnFalseAndOriginalValue_WhenJsonIsMalformed()
    {
        ...
        // Act
        var result = SagaMessageTemplatesJsonExtensionsJsonExtensions.TryFromJson(malformedJson, out value);
    ...
    public void TryFromJson_ShouldThrowArgumentNullException_WhenJsonIsNull()
    {
        ...
        // Act
        Action act = () => SagaMessageTemplatesJsonExtensionsJsonExtensions.TryFromJson(json!, out value);
    ...
    public void RoundTrip_ToJsonThenFromJson_ShouldPreserveOriginalValue()
    {
        ...
        // Act
        var json = SagaMessageTemplatesJsonExtensionsJsonExtensions.ToJson(originalMessage);
        var deserialized = SagaMessageTemplatesJsonExtensionsJsonExtensions.FromJson(json);
